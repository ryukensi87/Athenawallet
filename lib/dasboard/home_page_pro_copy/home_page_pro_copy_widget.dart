...
import 'home_page_pro_copy_model.dart';
export 'home_page_pro_copy_model.dart';

class HomePageProCopyWidget extends StatefulWidget {
  const HomePageProCopyWidget({Key? key}) : super(key: key);

  @override
  _HomePageProCopyWidgetState createState() => _HomePageProCopyWidgetState();
}

class _HomePageProCopyWidgetState extends State<HomePageProCopyWidget>
    with TickerProviderStateMixin {
  late HomePageProCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageProCopyModel());
