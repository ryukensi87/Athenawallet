...
import 'akun_page_model.dart';
export 'akun_page_model.dart';

class AkunPageWidget extends StatefulWidget {
  const AkunPageWidget({Key? key}) : super(key: key);
...
class _AkunPageWidgetState extends State<AkunPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AkunPageModel());
  }
