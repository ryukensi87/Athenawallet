...
DocumentReference? get currentUserReference =>
    loggedIn ? UserAkunRecord.collection.doc(currentUser!.uid) : null;

UserAkunRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserAkunRecord.getDocument(UserAkunRecord.collection.doc(uid))
              .handleError((_) {}),
    )
