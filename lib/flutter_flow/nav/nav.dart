...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomePageProWidget() : WelcomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'AccountSettingsLogin',
              path: 'accountSettingsLogin',
              builder: (context, params) => AccountSettingsLoginWidget(),
            ),
            FFRoute(
